...
public class MovieTitleGen
{
	public static void main(String[] args) throws Exception
	{
		...
		System.out.println("Leo's Random Movie Title Generator\n");
      ...
      int nou = 0 + (int)(Math.random()* nouns.length      );

		String adjective = adjectives[adj];
		String noun = nouns[nou];

		System.out.printf( "Your movie title is: %s %s", adjective, noun);
	}
