public class FunctionCallAlphabet
{
   public static void main(String[] args)
   {
      a();    // displays a word beginning with A
		...
		System.out.print(j(1) );    // returns a different word depending on what you pass it (1-3)
		...
		w(20);    // pass it any integer and it will display a word beginning with W 
		System.out.print(x(20) );    // returns a different word depending on what you pass it (1-2)
